...
Source: https://github.com/pytorch/vision/blob/main/torchvision/models/optical_flow/raft.py

Modifications by Ruiqi Wang,
...
def make_coords_grid(batch_size: int, h: int, w: int):
    ...
    coords = torch.stack(coords[::-1], dim=0).half().float() # CPSL Modified: originally .float()
